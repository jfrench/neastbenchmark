...
#'
#' An \code{\link[sf]{sf}} object containing data related to
#' breast cancer mortality in the Northeastern United
#' States.  The data include information from 245 counties
#' (or similar) and polygon information converted to
#' coordinate system EPSG 2263. The following variables are
