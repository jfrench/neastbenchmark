...
#' 
#' Benchmark data sets from Song and Kulldorff (2003).
#' Each data set is a 10000 x 245 matrix.  Each row
#' represents the data for a single simulated data
#' set.  The available data sets are
#' mixed01, mixed02, mixed04, mixed08, mixed16,
#' rural01, rural02, rural04, mixed08, rural16,
